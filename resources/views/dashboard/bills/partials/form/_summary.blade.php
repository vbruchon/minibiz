<x-form.section title="Résumé du devis">
  <div class="p-4 border border-gray-700 rounded-lg bg-gray-800/50 text-right space-y-1">
    <p class="text-sm text-gray-400">Sous-total : <span id="subtotal" class="text-white font-semibold">0.00 €</span></p>
    <p class="text-sm text-gray-400">Remise : <span id="discount-value" class="text-white font-semibold">0.00 €</span></p>
